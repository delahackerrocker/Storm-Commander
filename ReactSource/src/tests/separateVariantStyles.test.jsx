...
describe('separate variant style sources', () => {
  ...
  it('keeps random encounter comms around a centered board column', () => {
    ...
    expect(playerSoftSelectionRule).toContain('border: 3px solid rgba(216, 98, 32, 0.3192);')
    expect(playerSoftSelectionRule).toContain('inset: 23%;')
    expect(playerSoftSelectionRule).toContain('border-radius: var(--radius);')
    expect(playerSoftSelectionRule).toContain('inset 0 0 24px rgba(216, 98, 32, 0.112)')
    expect(playerSoftSelectionRule).toContain('0 0 30px rgba(216, 98, 32, 0.238)')
    expect(opponentSoftSelectionRule).toContain('border: 3px solid var(--storm-opponent-soft-ring')
    expect(opponentSoftSelectionRule).toContain('inset: 23%;')
    expect(opponentSoftSelectionRule).toContain('border-radius: var(--radius);')
    expect(opponentSoftSelectionRule).toContain('inset 0 0 24px var(--storm-opponent-soft-ring-inner')
    expect(opponentSoftSelectionRule).toContain('0 0 30px var(--storm-opponent-soft-ring-outer')
    ...
    expect(stormStyles).toContain('--storm-opponent-soft-ring: rgba(213, 166, 14, 0.3024);')
    expect(stormStyles).toContain('--storm-opponent-soft-ring: rgba(85, 170, 242, 0.3024);')
